...
; (function ($, window, document, undefined) {
	...
	*/
    ...
    Tree.prototype.template = {
        ...
        btnactive: '<button class="btn btn-success btn-circle" title="Kích hoạt" onclick="btnactive(event)"><i class="fa fa-check-circle"></i></button> ',
        btnedit: '<button class="btn btn-warning btn-circle" title="Sửa" onclick="btnedit(event)"><i class="fa fa-edit"></i></button>',
        btndel: '<button class="btn btn-danger btn-circle" title="Xóa"  onclick="btndel(event)"><i class="fa fa-trash-o"></i></button>',
        btngrant: '<button class="btn btn-primary btn-circle" onclick="btngrant(event)" title="Phân quyền" ><i class="fa fa-user"></i></button>',
        btnunactive: '<button class="btn btn-default btn-circle" onclick="btnactive(event)" title="Vô hiệu hóa" ><i class="fa fa-ban"></i></button>',
        btnviewdetail: '<button class="btn btn-info btn-circle" onclick="btnviewdetail(event)" title="Xem chi tiết" ><i class="fa fa-info"></i></button>'
    };
