...
<%@ Import Namespace="CKFinder.Connector" %>
...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "@cuongbx";
        LicenseKey = "F3CTJF545PNUQ7TVE73QACAB98RKLWA9";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = ConfigurationManager.AppSettings["New_Root_URL"];


        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.

        BaseDir = ConfigurationManager.AppSettings["Folder_New"];

        //BaseDir = ConfigurationManager.AppSettings["mediaPath"];
        ...
        type.Url = "~/media/gallery/";
        type.Dir = "~/media/gallery/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
