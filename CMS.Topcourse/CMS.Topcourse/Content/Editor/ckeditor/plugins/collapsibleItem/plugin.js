function getCollapsibleItem() {
    ...
    var script =
        '<div aria-multiselectable="true" class="panel-group" id="collapbsible-1" role="tablist">' +
        '   <div class="panel panel-default">' +
        '     <div class="panel-heading collapsible-item-heading" id="headingCollapbsible" role="tab">' +
        '<h4>' +
            ...
            '<a aria-controls="collapseCollapbsible" aria-expanded="false" class="collapsed collapsible-item-title-link" data-toggle="collapse" href="#collapseOne" role="button"><span class="collapsible-item-title-link-text">&nbsp; Title Text &nbsp;</span></a></h4>' +
        '    </div>' +
        '    <div aria-expanded="false" aria-labelledby="headingOne" class="collapse panel-collapse collapsible-item-collapse" id="collapseCollapbsible" role="tabpanel" style="height:0px">' +
...
CKEDITOR.plugins.add('collapsibleItem', {
        ...
        editor.widgets.add('collapsibleItem', {
            ...
            editables: {
                title: {
                    ...
                    allowedContent: 'strong em u span a'
                },
                content: {
    ...
    onLoad: function () {
        CKEDITOR.addCss(
            ...
            //'.collapsible-item-title-link-text {min-width:50px;display:inline-block;min-height:20px;height:100%;color: #1b6da3;}' +
