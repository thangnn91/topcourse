            ...
            e = function (a, tag, index, lst_row) {
                ...
                for (cellIdx = 0; cellIdx < a.length; cellIdx++) {
                    ...
                    if (!$.isNumeric(checkNum)) {
                        debugger
                        if (Utils.IsvalidateDate(checkNum)) {
                            if (index == 0) {
                    ...
                    if (countRowspan == 0) {
                        ...
                        if (Utils.validateDateTime(data)) {
                            ...
                            b.push('<' + tag + ' rowspan="' + countRowspan + '" align="center" style="border:1px solid #848484; vertical-align: middle;">' + Utils.dateTypeFormatter(data, 1) + '</' + tag + '>');
                        }
                        else {
                        ...
                        if ($.isNumeric(checkNum)) {
                            b.push('<' + tag + ' align="right" style="border:1px solid #848484; vertical-align: middle;text-align:right">' + Utils.ReplaceAll(numb, '.', '') + '</' + tag + '>');
                        }
                        else {
                            var data = (!a[cellIdx].replace ? a[cellIdx] : a[cellIdx].replace(/&(?!amp;)/g, "&amp;").replace(/[\x00-\x1F\x7F-\x9F]/g, ""));
                            var pos = data.indexOf('.');
                            ...
                            if (Utils.validateDateTime(data)) {
                                data = data.replace("T", " ");// replace time
                                b.push('<' + tag + ' align="center" style="border:1px solid #848484; vertical-align: middle;">' + Utils.dateTypeFormatter(data, 1) + '</' + tag + '>');
                            }
                            else {
